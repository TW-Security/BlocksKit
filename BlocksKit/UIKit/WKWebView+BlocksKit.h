...
*/
@property (nonatomic, copy, setter = bk_setShouldStartLoadBlock:, nullable) BOOL (^bk_shouldStartLoadBlock)(WKWebView *webView, NSURLRequest *request, WKNavigationType navigationType);
